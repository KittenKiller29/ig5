...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pMesh1->LoadMesh("C:/Users/azamat/Desktop/any/phoenix_ugv.md2")) {
            return false;
        }

        m_pMesh2 = new Mesh();

        if (!m_pMesh2->LoadMesh("C:/Users/azamat/Desktop/any/jeep.obj")) {
            return false;
        }

        m_pMesh3 = new Mesh();

        if (!m_pMesh3->LoadMesh("C:/Users/azamat/Desktop/any/hheli.obj")) {
            return false;
        }
